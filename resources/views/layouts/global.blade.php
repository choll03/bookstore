...
<body>
    ...
    <nav class="navbar navbar-expand p-0 navbar-fixed-top">
     <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="index.html"> Larashop </a>
      ...
      <div class="dropdown d-none d-md-block">
        ...
        @endif 
        <div class="dropdown-menu dropdown-menu-right pull-right" id="navbar-dropdown">
    ...
    <div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
        <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
            ...
            <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
              ...
              <li><a href="{{route('login')}}"><span class="oi oi-home"></span> Home</a></li>
              @if(\Auth::user()->roles != json_encode(['CUSTOMER']))
