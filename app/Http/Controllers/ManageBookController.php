...
class ManageBookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($cover){
          ...
          $new_book->cover = str_replace('book-covers/','',$cover_path);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($new_cover){
            if($book->cover && file_exists(storage_path('app/public/book-covers/' . $book->cover))){
                \Storage::delete('public/book-covers/'. $book->cover);
            }

            $new_cover_path = $new_cover->store('book-covers', 'public');

            $book->cover = str_replace('book-covers/','',$new_cover_path);
        }
