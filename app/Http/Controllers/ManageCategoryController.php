...
class ManageCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('image')){
            ...
            $new_category->image = str_replace('category_images/','',$image_path);
        }
    ...
    public function update (Request $request, $id){
        ...
        if($request->file('image')){
            if($category->image && file_exists(storage_path('app/public/category_images/' . $category->image))){
                \Storage::delete('public/category_images/' . $category->name);
            }
    
            $new_image = $request->file('image')->store('category_images', 'public');
    
            $category->image = str_replace('category_images/','',$new_image);
        }
